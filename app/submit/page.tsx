...
export default function SubmitPage() {
  ...
  const images = [
    ...
    { person: "Mr. Franzen", href: "/tej2o1-01_d-joe_franzen-easter-egg-1.webp" },
    { person: "Mr. Franzen", href: "/tej2o1-01_d-joe_franzen-easter-egg-2.webp" },
    { person: "Mr. Franzen", href: "/tej2o1-01_d-joe_franzen-easter-egg-3.webp" },
    { person: "Mr. Franzen", href: "/tej2o1-01_d-joe_franzen-easter-egg-4.webp" },
    { person: "Mr. Franzen", href: "/tej2o1-01_d-joe_franzen-easter-egg-5.jpg" },
  ]
              ...
              <Description>
                {error ?
                  ...
                  (<div>
                    ...
                    <p>
                      {
                        (body != undefined && status != undefined) ? "Data sent" : "Please wait for the data to send"
                      }
                    </p>
                  </div>)}
                <div>
